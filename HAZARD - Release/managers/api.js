...
module.exports = (app) => {
	...
	app.delete("/friends/api/v1/:accountId/friends/HazardBot", (req, res) => {
	...
	app.post("/friends/api/v1/:accountId/blocklist/HazardBot", (req, res) => {
		res.status(403).json({ "errorCode": "errors.com.epicgames.Neonite.common.forbidden", "errorMessage": "You cannot remove the bot", "messageVars": [], "numericErrorCode": 14004, "originatingService": "party", "intent": "prod" })
	...
	app.get("/account/api/public/account/displayName/:displayName", (req, res) => {
		...
		if (req.params.displayName != "HazardBot") return;
	...
	app.post("/friends/api/v1/:accountId/friends/HazardBot", (req, res) => {
		res.status(204).send()
	})
