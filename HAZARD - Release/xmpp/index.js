...
wss.on("connection", ws => {
    ...
    var BotJid = `HazardBot@neonite.dev/V2:Fortnite:WIN::Neonite-Bot-By-BeatYT`
        ...
        switch (doc.root.name) {
            ...
            case "message": {
                ...
                if (bWaitingForGiftNumValid && giftResults.length > 0) {
                    ...
                    profiledata.items[uuid.v4()] = {
                        ...
                        "attributes": {
                            ...
                            "giftedOn": new Date(),
                            "params": {
                                "userMessage": "Thanks for using Hazard"
                            },
                            "favorite": false
                        },
                        "quantity": 1
                ...
                switch (command.replace("!", '').toLowerCase()) {
                    ...
                    case "addbot":
                        functions.AddBot("CID_128_Athena_Commando_F_Hazmat")
                        break;
            ...
            functions.SendMessage(JSON.stringify(
                {
                    ...
                    "connection": {
                        "id": `HazardBot${BotNumber != 0 ? BotNumber : ""}@neonite.dev/V2:Fortnite:WIN::Neonite-Bot-By-BeatYT${BotNumber != 0 ? BotNumber : ""}`,
                        "meta": {
                    ...
                    "account_id": `HazardBot${BotNumber != 0 ? BotNumber : ""}`,
                    "account_dn": "HazardBot",
                    "member_state_updated": {
                        "urn:epic:member:joinrequestusers_j": JSON.stringify({ "users": [{ "id": `HazardBot${BotNumber != 0 ? BotNumber : ""}`, "dn": "HazardBot", "plat": "WIN", "data": JSON.stringify({ "CrossplayPreference_i": "1", "SubGame_u": "1" }) }] }),
                        "urn:epic:member:dn_s": `HazardBot`,
                    },
                    "joined_at": new Date(),
                    "updated_at": new Date()
                }
            ...
            functions.SendMessage(JSON.stringify(
                {
                    ...
                    "member_state_updated": {
                        ...
                        "Default:AthenaBannerInfo_j": "{\"AthenaBannerInfo\":{\"bannerIconId\":\"BRSeason02GasMask\",\"bannerColorId\":\"defaultcolor0\",\"seasonLevel\":100}}",
